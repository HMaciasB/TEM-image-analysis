...
def modelPath = "D:/OOCITOS QUPATH PROJECT/stardist_model_1_channel.pb"

// Configuración de StarDist
def stardist = StarDist2D.builder(modelPath)
        .preprocess(
            StarDist2D.imageNormalizationBuilder()
                .maxDimension(4096)  // Reduce el tamaño máximo de la imagen para el procesamiento
                .percentiles(1, 99.5)  // Normalización
                .build()
        )
        .includeProbability(true)  // Incluir probabilidad en la salida
        .threshold(0.85)  // Ajustar umbral para la detección
        .pixelSize(0.0221)  // Tamaño de píxel basado en tu imagen
